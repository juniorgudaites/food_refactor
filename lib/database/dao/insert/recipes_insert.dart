...
class RecipesInsert {
  static final Recipe boloChocolate = Recipe(
      ...
      listIngredients:
          Ingredient(name: 'Ovo', quantity: '4').toString() + '\n' +
          Ingredient(name: 'Chocolate em Pó', quantity: '4 Colheres(Sopa)').toString() + '\n' +
          Ingredient(name: 'Manteiga', quantity: '2 Colheres(Sopa)').toString() + '\n' +
          Ingredient(name: 'Farinha de Trigo', quantity: '3 Xícaras(Chá)').toString() + '\n' +
      ...
      preparationMode: 'Em um liquidificador adicione os ovos, o chocolate em pó, a manteiga, a farinha de trigo, o açúcar e o leite, depois bata por 5 minutos.\n'+
  ...
  static final Recipe boloCenoura = Recipe(
      ...
      Ingredient(name: 'Ovo', quantity: '4').toString() + '\n' +
          ...
          Ingredient(name: 'Farinha de Trigo', quantity: '2 Xícaras(Chá)').toString() + '\n' +
          Ingredient(name: 'Açúcar', quantity: '2 Xícaras(Chá)').toString() + '\n' +
  ...
  static final Recipe brigadeiro = Recipe(
      ...
      listIngredients:
          Ingredient(name: 'Chocolate em Pó', quantity: '7 Colheres(Sopa)').toString() + '\n' +
          Ingredient(name: 'Leite Condensado', quantity: '1').toString() + '\n' +
          Ingredient(name: 'Margarina', quantity: '1 Colher(Sopa)').toString(),
      preparationMode:
  ...
  static final Recipe peDeMoleque = Recipe(
      ...
      listIngredients:
      Ingredient(name: 'Amendoim Torrado', quantity: '1/2 kg').toString() + '\n' +
          Ingredient(name: 'Açúcar', quantity: '1/2 kg').toString() + '\n' +
          Ingredient(name: 'Margarina', quantity: '3 Colheres(Sopa)').toString() + '\n' +
  ...
  static final Recipe lasanha = Recipe(name: 'Lasanha',
      description: 'Lasanha Tradiocional de Presunto, Queijo e Carne',
      listIngredients:
      Ingredient(name: 'Massa de Lasanha', quantity: '1 Pacote').toString() + '\n' +
  ...
  static final Recipe pizza = Recipe(name: 'Pizza',
      description: 'Pizza de Frango',
      listIngredients:
          Ingredient(name: 'Leite', quantity: '1 Xícaras(Chá)').toString() + '\n' +
          Ingredient(name: 'Farinha de trigo', quantity: '2 Xícaras(Chá)').toString() + '\n' +
          Ingredient(name: 'Fermento', quantity: '1 Colher(Sobremesa)').toString() + '\n' +
          Ingredient(name: 'Óleo', quantity: '2 Colheres(Sopa)').toString() + '\n' +
          Ingredient(name: 'Sal', quantity: '1 pitada').toString() + '\n' +
          Ingredient(name: 'Molho sabor pizza', quantity: '1 sachê').toString() + '\n' +
          Ingredient(name: 'Molho à bolonhesa', quantity: '1 sachê').toString() + '\n' +
